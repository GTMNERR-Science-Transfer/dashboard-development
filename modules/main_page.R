        ...
        tabsetPanel(
          tabPanel("Overview", 
                   tagList(
                     ...
                     p("Use the dropdown menu above to see locations with data availability. To view these data, use the menu on the left of the screen.")
                   )),
          tabPanel("Using the Dashboard",
                   tagList(
                     h4("Navigation"),
                     p("Use the left-hand menu to navigate through different sections."),
                     img(src = "www/path_to_example_image1.png", height = "300px"),
                     p("You can view different types of data by selecting the appropriate options."),
                     p(HTML("On the map, click into the stations represented by the icon <img src='www/path_to_icon.png' height=20px /> to display the dashboard for the selected data type.")),
                     p("The dashboard will be displayed below the map"),
                     p(HTML("You can also click on the icons <img src='www/path_to_zoom_in_icon.png' height=20px /> to zoom in and <img src='www/path_to_zoom_out_icon.png' height=20px /> to zoom out on the map.")),
                   ))
        )
      ),
      size = "l",
